...
const Home = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <div className={classes.containerOffungszeiten}>
      <img alt="food" src={petraQuartor} className={classes.petraQuartor} />
        <div className={classes.containerQuator}>
          ...
          <div className={classes.dayFourth}>
            <h3>Donnerstag</h3>
            <h3 className={classes.h3DayFourth}>11:00 - 14:00 17:00 - 00:00</h3>
          </div>
          <hr className={classes.horizontallyLineFourth}></hr>
          <div className={classes.dayFifth}>
            <h3>Freitag</h3>
            <h3 className={classes.h3DayFifth}>11:00 - 14:00 17:00 - 00:00</h3>
          </div>
          ...
          <div className={classes.daySeventh}>
            <h3>Sonntag</h3>
            <h3 className={classes.h3DaySeventh}>11:00 - 22:00 <br></br>durchehend geoffent</h3>
          </div>
